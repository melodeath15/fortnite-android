package com.fortnite.melodic;


import com.fortnite.melodic.BuildConfig;

public class WebViewAppConfig
{
	// Envato purchase code
	public static final String PURCHASE_CODE = "8431507";
	...
	public static final String ANALYTICS_TRACKING_ID = "UA-120126712-1";

	// unit ids for AdMob,
	// leave these constants empty if you do not want to use AdMob
	public static final String ADMOB_UNIT_ID_BANNER = "ca-app-pub-2648520271685365/7931890795";
	public static final String ADMOB_UNIT_ID_INTERSTITIAL = "ca-app-pub-2648520271685365/7193933314";
	...
	public static final String ADMOB_TEST_DEVICE_ID = "670B51A759DBD813902331428C133B62";
